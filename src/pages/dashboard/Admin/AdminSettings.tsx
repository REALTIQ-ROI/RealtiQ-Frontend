  ...
  return (
    <AdminLayout>
      <section className="p-8 max-w-5xl mx-auto space-y-8">
        <div>
          <p className="text-xs uppercase tracking-widest text-secondary font-bold">Account Management</p>
          <h1 className="text-3xl font-extrabold">Settings</h1>
          <p className="text-sm text-secondary mt-1">Manage the signed-in admin profile and support contact details.</p>
        </div>
        ...
        {loading ? (
          ...
          <form className="space-y-8" onSubmit={onSave}>
            <section className="bg-surface-container-lowest p-8 rounded-xl">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div>
                  ...
                  <p className="text-sm text-secondary">Update the information used across the admin console.</p>
                </div>
            ...
            <section className="bg-surface-container-lowest p-8 rounded-xl border border-outline-variant/10">
              <h3 className="text-lg font-bold mb-5">Security Summary</h3>
