    ...
    <div className="p-8 max-w-6xl mx-auto">
      {user?.role === 'admin' ? (
        <header className="mb-8 flex flex-col gap-3">
          ...
          <p className="text-secondary text-sm">Track installment plans, remaining balances, and payment redirects from Paystack.</p>
        </header>
      ) : null}
        ...
        <section className="bg-surface-container-lowest rounded-xl border border-outline-variant/10 p-6 space-y-4 mb-8">
          <div className="flex items-center justify-between gap-3">
            <div>
              ...
              <h2 className="text-2xl font-extrabold tracking-tighter mt-1">{selectedInstallment ? selectedInstallment._id : id}</h2>
            </div>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                <div>
                  ...
                  <p className="font-semibold">{formatPropertyRef(selectedInstallment.propertyId)}</p>
                </div>
                <div>
              ...
              <article key={installment._id} className="bg-surface-container-lowest rounded-xl border border-outline-variant/10 p-5 space-y-4">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                  <div>
                    ...
                    <p className="text-sm text-secondary">{formatPropertyRef(installment.propertyId)}</p>
                  </div>
